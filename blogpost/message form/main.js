 ...
 var messagesRef = firebase.database().ref('rain rain go away');
...
function submitForm(e){
  ...
  var storyname=getInputVal('storyname');

  // Save message
  saveMessage(name, email, message,storyname);
...
function saveMessage(name, email, message,storyname){
